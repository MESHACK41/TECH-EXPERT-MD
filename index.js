...
var session = conf.session.replace(/TECH-EXPERT-MD%%/g,"");
...
setTimeout(() => {
    async function main() {
        ...
        const sockOptions = {
            ...
            browser: ['Tech-Expert-md', "safari", "1.0.0"],
...
if (conf.AUTO_REACT_STATUS=== "yes") {
    zk.ev.on("messages.upsert", async (m) => {
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            const dj = '255752593977';
            const dj2 = '255711389698';
            const dj3 = "255764182801";
            const luffy = '255791815967';
            ...
            console.log("TECH EXPERT MD ONLINE");
     ...
     try {
        ...
        if (texte.includes('https://') && verifGroupe &&  yes  ) {
         ...
         console.log("lien detecté")
            var verifFredAdmin = verifGroupe ? admins.includes(idBot) : false;
...
zk.ev.on('group-participants.update', async (group) => {
    ...
    try {
        ...
        if (group.action == 'add' && (await recupevents(group.id, "welcome") == 'on')) {
            let msg = `*EXPERT MD WELCOME IN THE GROUP MESSAGE*`;
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                ...
                console.log("✅ Tech Expert Md Connected to WhatsApp! ☺️");
                console.log("--");
                ...
                console.log("Loading Rtech expert Commands ...\n");
