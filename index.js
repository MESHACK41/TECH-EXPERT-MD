...
import smartAutoReactNewsletter from './plugins/channelreact.js';
...
console.log(chalk.bold.redBright(`\n✰ Starting Tech-Expert-Md ✰\n`))

// FIX: Use cfonts.say() directly instead of destructuring
cfonts.say('Tech-Expert-Md', {
  font: 'block',
  align: 'center',
  colors: ['magentaBright']
})

cfonts.say(`Developed By • MrExpert`, {
  font: 'console',
  align: 'center',
  colors: ['blueBright']
})
...
async function connectionUpdate(update) {
  ...
  if (connection == 'open') {
    console.log(chalk.bold.green('\n❀ Tech Expert Md Connected Successfully ❀'))
...
const app = express()
app.get('/', (req, res) => res.status(200).send('✅ Tech-Expert-Md is running'))
