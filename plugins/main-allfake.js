...
handler.all = async function (m) {
    ...
    global.creator = 'wa.me/255752593977'
    global.botUser = `${conn.user.jid.split('@')[0]}`
    
    // Channel and group names
    global.channelName = '=͟͟͞❀ Fredi Ai ⏤͟͟͞͞★'
    global.channelName2 = '=͟͟͞❀ fee hub ⏤͟͟͞͞★'
    global.groupName = 'ᰔᩚ fee hub ❀'
    global.communityName = 'ᰔᩚ javascript users ❀'
    
    // Ready message and profile picture
    global.ready = '❀ *Here you go ฅ^•ﻌ•^ฅ*'
    global.profilePhoto = await conn.profilePictureUrl(m.sender, 'image').catch(() => 'https://files.catbox.moe/s3wv2g.jpg')

    // Channel lists and random channel selection
    global.channelIdList = ["120363313124070136@newsletter", "120363313124070136@newsletter"]
    global.channelNameList = ["Fredi Ai", "Fee hub"]
    ...
    // Social media links
    const channel = 'https://github.com/FezChat'
    const community = 'https://github.com/FezChat'
    const web = 'https://github.com/Fred1e'
    const web2 = 'https://github.com/MESHACK41/TECH-EXPERT-MD'
    const web3 = 'fredi-ai-site.vercel.app'
    ...
    global.icon = pickRandom([
        'https://files.catbox.moe/s3wv2g.jpg',
    ])
