...
let handler = async (m, { conn }) => {
  ...
  const botname = conn.user?.name || 'Tech-Expert-Md 🌸';
...
`.trim();
  ...
  // Channel information
  let channelRD = {
    id: '120363313124070136@newsletter',
    name: 'Mr Expert Tech',
  };

  // Media assets
  let banner = 'https://files.catbox.moe/s3wv2g.jpg';
  let redes = 'https://fredi-ai-site.vercel.app';
