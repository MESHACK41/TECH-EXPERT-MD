...
let handler = async (m, { conn }) => {
  try {
    let res = await fetch('https://api.github.com/repos/MESHACK41/TECH-EXPERT-MD')
    ...
    await conn.sendMessage(m.chat, {
      ...
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          newsletterJid: '120363313124070136@newsletter', // Replace with your channel ID
          newsletterName: 'Mr Expert', // Your channel name
          serverMessageId: -1
        },
        externalAdReply: {
          title: '✨ Tech-Expert-Md',
          body: 'Official bot repository',
          thumbnailUrl: 'https://files.catbox.moe/s3wv2g.jpg',
