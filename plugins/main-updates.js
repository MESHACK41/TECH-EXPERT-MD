...
const config = {
    repoOwner: 'MESHACK41',
    repoName: 'TECH-EXPERT-MD',
    channelJid: '120363313124070136@newsletter', // Your newsletter channel JID
    checkInterval: 5, // Minutes between checks
    notificationTarget: '120363313124070136@g.us' // YOUR bot's number or specific chat
}
...
function createContextInfo(url) {
    return {
        forwardedNewsletterMessageInfo: {
            ...
            newsletterName: 'Mr Expert Updates',
            serverMessageId: -1
        },
        externalAdReply: {
