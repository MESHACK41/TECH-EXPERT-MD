...
module.exports = { session: process.env.SESSION_ID || 'ezra',
    ...
    URL: process.env.URL || "https://files.catbox.moe/s3wv2g.jpg",  
    ...
    AUTO_STICKER : process.env.AUTO_STICKER || "no", 
    AUTO_STATUS_TEXT: process.env.AUTO_STATUS_TEXT || 'Your Status Seen By Tech Expert Md',   
    ...
    CAPTION : process.env.CAPTION || "Fee-Xmd",
    BOT : process.env.BOT_NAME || 'Fee-Xmd',
